        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-xl border border-gray-800 bg-gray-900/50">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <CircularMetric label="Open interest pulse" sublabel="Futures" value="36" color="purple" />
          ...
          <div className="p-6 rounded-xl border border-gray-800 bg-gray-900/50">
            ...
            <div className="p-4 mt-4 rounded-lg bg-gray-800/50 border border-gray-700 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Positioning bearish bias</div>
              </div>
            </div>
          </div>
        </div>
...
function CircularMetric({
  ...
  const colorMap: Record<string, { circle: string; bg: string }> = {
    blue: { circle: '#3b82f6', bg: 'bg-blue-900/30' },
    purple: { circle: '#a855f7', bg: 'bg-purple-900/30' },
    green: { circle: '#10b981', bg: 'bg-green-900/30' },
    pink: { circle: '#ec4899', bg: 'bg-pink-900/30' },
    orange: { circle: '#f59e0b', bg: 'bg-orange-900/30' },
  }

  const c = colorMap[color] || colorMap.blue

  return (
    <div className={`p-4 rounded-lg ${c.bg} border border-gray-700 flex flex-col items-center`}>
...
function CircularMetricLarge({
  ...
  const colorMap: Record<string, { circle: string }> = {
    blue: { circle: '#3b82f6' },
    green: { circle: '#10b981' },
  ...
  return (
    <svg className="w-28 h-28" viewBox="0 0 100 100">
      <circle cx="50" cy="50" r="45" fill="none" stroke="#374151" strokeWidth="2" />
      <circle cx="50" cy="50" r="45" fill="none" stroke={c.circle} strokeWidth="4" />
